              ...
              ${this.results?.map(
                (result, index) => y`<a
                  ...
                  @click=${event => {
                    ...
                    l(result.action(result.queries));
                  }}
